...
const validateForm = (): boolean => {
  if (!form.value.description.trim()) {
    error.value = 'Please describe the item you found'
    return false
  }
  ...
  if (!form.value.dateFound) {
    error.value = 'Please enter when you found the item'
    return false
  }
...
const submitForm = async () => {
  ...
  try {
    ...
    success.value = 'Your found item report has been submitted successfully!'
...
<template>
  <main>
    ...
    <p>Help us reunite this item with its owner by providing as much detail as possible.</p>
    ...
    <form @submit.prevent="submitForm" class="report-form">
      <div class="form-group">
        ...
        <textarea
          ...
          class="form-input"
          placeholder="Describe the item you found in detail (e.g., black AirPods case with a sticker on it)"
          rows="3"
          required
        ></textarea>
      </div>
      ...
      <div class="form-row">
        ...
        <div class="form-group">
          ...
          <input
            ...
            type="text"
            class="form-input"
            placeholder="e.g., library entrance, coffee shop"
            required
          />
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <textarea
          ...
          class="form-input"
          placeholder="Any other details that might help identify the owner (e.g., where exactly you left it, if it was turned in somewhere)"
          rows="2"
        ></textarea>
      </div>
